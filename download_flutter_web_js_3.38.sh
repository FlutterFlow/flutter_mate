...
# Uses FVM with Flutter 3.38.5 (dartDevEmbedder module format)
#
# Usage: ./download_flutter_web_js_3.38.sh <project_dir> [port]
#
# JS files will be saved to <project_dir>/build_js/
#
# Example:
#   ./download_flutter_web_js_3.38.sh /tmp/flutter_debug_dummy 8083
#   ./download_flutter_web_js_3.38.sh /path/to/real_project 8084
...
fvm flutter run -d web-server --web-port=$PORT > /tmp/flutter_web_server_$PORT.log 2>&1 &
FLUTTER_PID=$!
